...
gem 'thin' # or mongrel
#gem 'padrino', "0.9.4"
#gem 'padrino-core', "0.9.4"
#gem 'padrino-helpers', "0.9.4"
gem 'padrino-core', "0.9.4"#, :path => "vendor/padrino-framework/padrino-core"
gem 'padrino-helpers', "0.9.4"#, :path => "vendor/padrino-framework/padrino-helpers"